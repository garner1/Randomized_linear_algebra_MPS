function [elist,mps] = heisenberg(N,D,size_bulk,site_in,iter,m_in,sweeps,jx,jy,jz,h,phi,algorithm)
d = 2;
pn = 2; ln = pn;%2*pn; %used in rand approx of the environment
ph = 4; lh = ph;%2*ph; %used in rand approx of the environment
...
while count < sweeps, 
    ...
    if site_den<=N, precision = 1e-4;else precision = 1e-5;end
