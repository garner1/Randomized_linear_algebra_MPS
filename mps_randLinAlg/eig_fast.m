function [U,D] = eig_fast(A,k,its,l)
%PCA  Low-rank approximation in SVD form (it is an alternative to eigs 
%     for small l~5 and large its~20).
%
%
...
%
% Form the small matrix B = Q'*A*Q
%
  B = Q'*A*Q;

%
% Compute an eigenvalue decomposition B = V*Λ*V'
%
  [V,D] = eig(B);
  
%
% Form the orthonormal matrix U = Q*V
%
 U = Q*V;
 clear V;
